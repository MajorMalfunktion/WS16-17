...
\\
I.V.:\\
Die Aussage gelte fuer alle Vorgaenge von $n < 3, n \in \mathbb{N}$\\
\\
I.S.:\\
$
    a_n
...
\\
I.V.:\\
Die Aussage gelte fuer bel., aber festes $n \in \mathbb{N}$\\
\\
I.S.:\\
$
z.z.:\\
...
Eine moegliche Def. fuer alle geraden zahlen $G$ waere $G = \{2 * n | n \in \mathbb{N}\}$\\
Offensichtlich gilt:
(i)  $2n, 2 \in G$\\
(ii) und dass die Addition von nur geraden Zahlen eine gerade Zahl ergibt.\\
\\
Damit gillt $\forall n \in \mathbb{N}.n^2 + n + 2\ ist\ gerade$\\
\newpage
\subsection{Teilbarkeitsrelation}
\subsubsection\
- reflexiv, da $\forall x \in \mathbb{N}. x | x$ (k = 1)\\
\\
-transitiv, da $\forall x,y,z \in \mathbb{N}.x | y \land y | z \Rightarrow x | z$ (x * k = z)\\
\\
noch zu zeigen:\\
Teilbarkeitsrelation ist noethersch(!)\\
bzw. jede nichtleere Teilmenge muss bzgl. "I" ein minimales Element besitzt.\\
\\
